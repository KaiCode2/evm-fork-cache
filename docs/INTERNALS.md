...
still O(total state). The decisions and the full cost model are in
[`phase-5-spec.md`](phase-5-spec.md) and [`ROADMAP.md`](ROADMAP.md), and the
residual is recorded in [`KNOWN_ISSUES.md`](KNOWN_ISSUES.md).
